...
error_reporting(E_ALL);
    ...
    $url='http://jindouyun.gz11.hostadm.net/';// 测试
    $url='http://jindouyun.com/';// 本地

    // $token='e76824d9e17d3162ff915837466e488d';
    $user_id='65';// 测试
    $user_id='66';// 本地
    // $user_id='67';// 本地 总代 13420246244
    // $user_id='61';// 测试 总代 18067859786

    // 会员 address_list  act_edit_address  drop_consignee  act_address_default my_message  my_message_details my_message_del send_message register act_login get_user_info act_edit_profile act_edit_password reset_passwd logout collection_list collection collection_del act_edit_img card_list bind_bank_card edit_bank_card card_detail del_bank_card done order_detail cancel_order affirm_received apply_agent add_goods goods_list change_price pai_list add_pai proxy_list goods_info del_goods_img share_list share
    ...
    // 文章 get_article get_article_list
    ...
    // $data=array_merge($data,array(
    //     'act'=>'get_article',
    //     'article_id'=>22, //文章id  帮助中心id:3  客服中心id:4  关于我们id:5  协议id:6  售后服务id:22
    // ));
    // 拍摄管理列表
    // $data=array_merge($data,array(
    //     'act'=>'pai_list',
    ...
    //     'act'=>'add_pai',
    //     'user_id'=>$user_id, //会员id 
    //     // 'goods_id'=>31, //商品id 编辑时传该参数
    //     'user_sn'=>$user_id, //对应供货商编号 编辑时不用传
    //     'goods_name'=>'king22',// 商品名称 编辑时不用传
    //     // 'video'=>'@E:\\www\\test\\aa.png;type=image/jpeg',
    //     // 'images0'=>'@E:\\www\\test\\logo.png;type=image/jpeg',
    ...
    $data=array_merge($data,array(
        ...
        'cat_id'=>'5', // 商品分类
        // 'sort'=>'last_update', // last_update（最新）
        ...
        'intro'=>'new', // 新品new 热销hot 特价promotion
