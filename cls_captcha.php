...
class captcha
{
    ...
    var $themes_jpg = array(
        ...
        3 => array('captcha_bg2.jpg', 0, 0, 0),
        4 => array('captcha_bg2.jpg', 0, 0, 0),
        5 => array('captcha_bg2.jpg', 0, 0, 0),
    );

    var $themes_gif = array(
        1 => array('captcha_bg2.gif', 0, 0, 0),
        2 => array('captcha_bg2.gif', 0, 0, 0),
        3 => array('captcha_bg2.gif', 0, 0, 0),
        4 => array('captcha_bg2.gif', 0, 0, 0),
        5 => array('captcha_bg2.gif', 0, 0, 0),
    );
    // var $themes_jpg = array(
